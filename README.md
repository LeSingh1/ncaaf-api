...
![CI](https://github.com/LeSingh1/ncaaf-api/actions/workflows/test.yml/badge.svg) ![license](https://img.shields.io/badge/license-MIT-blue.svg) ![node](https://img.shields.io/badge/node-%E2%89%A518-brightgreen.svg) ![dependencies](https://img.shields.io/badge/dependencies-0-success.svg)

Unofficial Node client for ESPN's college football data. ESPN serves college football under
`football/college-football`, and this wraps those endpoints with retry/timeout
transport and parsers that return clean data.

Part of the [espn-api](https://github.com/LeSingh1/espn-api) family. The parent
is one client for every sport. This one is just college football, in the style of
swar/nba_api.
...
```
git clone https://github.com/LeSingh1/ncaaf-api
cd ncaaf-api
node examples/scoreboard.js   # college football games
...
A scheduled GitHub Action runs once a day, pulls that day's college football games from
